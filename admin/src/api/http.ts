...
export const request = async function (url: string, method: Method, queryParams?: any, fromdata?: any): Promise<any> {
...
export const requestBody = async function (url: string, method: Method, querys?: any, body?: any): Promise<any> {
    let config;

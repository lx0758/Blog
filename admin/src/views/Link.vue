  ...
  <el-container direction="vertical">
    ...
    <el-space wrap>
      ...
      <el-input
          ...
          size="small"
          clearable/>
      <blog-select v-model:value="filter.status" v-bind:type="6" size="small"></blog-select>
      ...
      <el-button type="primary" @click="onAddLink" size="small">新增短链</el-button>
    </el-space>
  ...
  <el-dialog :title="(!dialogData.id ? '新增' : '编辑') + '友链'" v-model="dialog" :close-on-click-modal="false">
    <el-form ref="dialog" :model="dialogData" :rules="dialogRules" label-width="120px">
      ...
      <el-form-item label="状态" prop="status">
        <blog-select v-model:value="dialogData.status" v-bind:type="6" size="small"></blog-select>
      </el-form-item>
      <el-form-item>

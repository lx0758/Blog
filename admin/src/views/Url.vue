<template>
    ...
    >
      ...
      <el-table-column label="操作" width="160">
        <template #default="scope">
          ...
          <el-button plain type="danger" size="small" @click="onDeleteUrl(scope.row)"
            >删除</el-button
          >
        </template>
      </el-table-column>
  ...
  <el-dialog
    :title="(editUrlDialogState.formModel.id != 0 ? '新增' : '编辑') + '短链'"
    v-model="editUrlDialogState.isShow"
    :close-on-click-modal="false"
  >
    <el-form ref="editUrlDialogStateFormRef" :model="editUrlDialogState.formModel" :rules="editUrlDialogState.formRules" label-width="120px">

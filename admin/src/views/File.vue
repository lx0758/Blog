<template>
  <el-container class="full-page" direction="vertical">
    ...
    <el-table class="full-page" stripe :data="state.data.list" @sort-change="onSortChange">
      ...
      <el-table-column :formatter="onFormatFileSize" prop="length" label="大小" width="100"
      ...
      <el-table-column label="操作" width="160">
        <template #default="scope">
          ...
          <el-button plain type="danger" size="small" @click="onDeleteUpload(scope.row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
  ...
  <el-dialog :title="(editFileDialogState.formModel.id != 0 ? '新增' : '编辑') + '文件'" v-model="editFileDialogState.isShow"
    ...
    <el-form ref="editFileDialogStateFormRef" :model="editFileDialogState.formModel" label-width="80px">
      <el-form-item label="选择文件">
        <el-upload drag action="" :on-change="onUploadChange" :multiple="false" :auto-upload="false"
